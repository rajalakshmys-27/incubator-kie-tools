...
- Extension points compatible with the jBPM Engine and Kogito. See [BPMN Editor Extensions](./docs/bpmn-editor-extensions.md) for complete documentation.
...
- 👉 [BPMN Editor Extensions](./docs/bpmn-editor-extensions.md) - Extension points and conventions beyond BPMN 2.0
